...
if (!conf || conf.version !== "1.4.0") {//如果配置不存在则初始化一个
...
let img_land_left = document.createElement("a");
img_land_left.classList.add("img_land_left");
let img_land_right = document.createElement("a");
